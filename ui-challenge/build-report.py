...
trans_matrix = {
	'tests/test_find_a_therapist.py' : 'Test Find a Therapist',
	'tests/test_landing_page_smoke.py' : 'Test Landing Page Smoke',
	'tests/test_login.py' : 'Test Login',
	'tests/test_find_a_therapist_docker.py' : 'Test Find a Therapist',
	'tests/test_landing_page_smoke_docker.py' : 'Test Landing Page Smoke',
	'tests/test_login_docker.py' : 'Test Login',
}
